...
if [ -d "$APP_DIR" ]; then
    chown -R monopoly:monopoly $APP_DIR
    echo "Set ownership of $APP_DIR to monopoly"
else
    echo "WARNING: $APP_DIR does not exist. Clone the repo first."
fi
...
echo "=========================================="
echo ""
echo "1. Run the install script as monopoly user:"
echo "   su - monopoly"
echo "   cd /opt/monopoly"
echo "   ./deploy/install.sh"
echo ""
echo "2. Then as root, enable the service:"
